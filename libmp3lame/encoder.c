...
{                       /* Output */
    ...
    ****************************************/

    {
        ...
        // Both values are 2
        // printf("In Psychoacoustic model, channels out: %d", cfg->channels_out);
        // printf("In Psychoacoustic model,mode gr: %d", cfg->mode_gr);
        for (gr = 0; gr < cfg->mode_gr; gr++) {
            for (ch = 0; ch < cfg->channels_out; ch++) {
